...
def main():
    ...
    for CATEGORY in categories:
        DISCLOSURE_FILE = f"../SAGE-BERT_embeddings/Infosys_embeddings/{CATEGORY}_disc.json"
        REGULATION_FILE = f"../SAGE-BERT_embeddings/BRSR_embeddings/{CATEGORY}_reg.json"
