"""
Generate SAGE-BERT embeddings for regulation clauses.
...
def main():
    ...
    print("=" * 70)
    print("EMBED REGULATION CLAUSES WITH SAGE-BERT")
    print("=" * 70)
    ...
    for file_name, category_name in categories.items():
        ...
        # Save output
        output_file = Path(OUTPUT_DIR) / f"{file_name}_BRSR_embeddings.json"
