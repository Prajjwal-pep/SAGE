"""
Generate SBERT embeddings for company disclosure clauses.
...
def load_and_embed_category(category_file, category_name, company_name, report_year):
...
def main():
    ...
    print("=" * 70)
    print("EMBED COMPANY DISCLOSURE CLAUSES")
    print("=" * 70)
    ...
    for file_name, category_name in categories.items():
        ...
        output_data = load_and_embed_category(
            input_file, category_name, COMPANY_NAME, REPORT_YEAR
        )
